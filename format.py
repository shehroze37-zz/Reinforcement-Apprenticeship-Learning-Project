...
for i in range(episodes):
    ...
    while not game.is_episode_finished():
        ...
        print('Image [0] ' + str(img.shape[0]))
        print('Image [1] ' + str(img.shape[1]))
        print('Image [2] ' + str(img.shape[2]))
        ...
        print('Image M [0] ' + str(img.shape[0]))
        print('Image M [1] ' + str(img.shape[1]))
        print('Image M [2] ' + str(img.shape[2]))    
